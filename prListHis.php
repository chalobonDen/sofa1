...
$userQuery = "SELECT * FROM `document_header_purchase` JOIN `vendors` using(Vendor_ID)
                where `Doc_type_ID` = 1 and status=1 and mod(`Doc_purchase_ID`,2)=1
...
<center>
	<div><br><br><br><br>
    <h1><b>Purchase Requisition History List <i class="fa fa-history fa-lg" aria-hidden="true"></i></b></h1><br><br>
    <a href="prList.php"><h3>Purchase Requisition List</h3></a><br>
    <a href="create_pr.php"><h3>Create Purchase Requisition</h3><i class="fa fa-file-text-o fa-lg" aria-hidden="true"></i></h3></a><br><br><br><br></a>
</div> 
	...
	<thead>
		...
		<?php } ?>
					...
					<form action="select_pr_his.php" method="post">	
						<input type="submit" name="po" value="View PR" class="genric-btn danger radius">
					</form>
					<br>				
			</tr>
			<br>
