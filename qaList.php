...
$userQuery = "SELECT * FROM `document_header_sale` JOIN `customers` using(Customer_ID)
                where `Doc_type_ID` = 5 and status_c=0
...
<center>
	<div><br><br><br><br>
    <h1><b>Quotation List</b></h1><br><br>
    <a href="qaListHis.php"><h3>Quotation History<i class="fa fa-history fa-lg" aria-hidden="true"></i></h3></a>
</div> 
    ...
    <tbody>
		<?php while ($row = mysqli_fetch_assoc($result)) { ?>
            <tr >
                <td><center>INQ#00<?=$row["Ref_ID"]?></center></td>
                <td><center>QA#00<?=$row["Doc_sale_ID"]?></center></td>
                <td><center><?=$row["Customer_name"]?></center></td>
                <td><center><?=$row["Doc_date"]?></center></td>

                <td><center><a href="qa_mat.php?id=<?=$row["Doc_sale_ID"]?>">
                  <i class="genric-btn danger radius">ADD Product</i>
                  </a></center>
                </td>
                <td><center><a href="show_qa1.php?id=<?=$row["Doc_sale_ID"]?>">
                  <i class="genric-btn danger radius">Create SO</i>
                  </a></center>
                </td>
                <td><center><a href="show_qa.php?id=<?=$row["Doc_sale_ID"]?>">
