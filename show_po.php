...
?>
    ...
    <form method="post" action="goodreceive.php">
            ...
            <input name="Ref_ID" type="hidden" value="<?=$row3["Ref_ID"]?>" readonly>
            <button class="w3-button w3-block w3-section w3-blue w3-ripple w3-padding"><i class="fas fa-check" style='font-size:27px'></i>GOOD RECEIVE</button>
    </form>
