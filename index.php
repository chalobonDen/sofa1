        	...
        	<div class="container">
        		<div class="home_blog_inner">
        			<div class="row h_blog_item">
        				<div class="col-lg-6">
							<div class="h_blog_img">
								<img class="img-fluid" src="img/sofa/sofa1.png"  alt="">
							</div>
						</div>
						<div class="col-lg-6">
							<div class="h_blog_text">
								<div class="h_blog_text_inner left">
									<h4>Indicate your style<br /></h4>
									<h5>" If a single piece of furniture has the ability to define the style of a personal living space,that piece would be the sofa "</h5>
        			...
        			<div class="row h_blog_item">
						<div class="col-lg-6">
							<div class="h_blog_text">
								<div class="h_blog_text_inner right">
									<h4> Comfortable </h4>
									<p>Pick a sofa appropriately sized for your living space, so you can enjoy its comfort without bumping into bulky seating as you pass by.<br /> a comfortable sofa allows you to spend many hours relaxing with your family.</p>
									<a class="main_btn2" href="#">Explore Gallery</a>
								</div>
							</div>
						</div>
						<div class="col-lg-6">
							<div class="h_blog_img">
								<img class="img-fluid" src="img/sofa/sofa2.png" alt="">
							</div>
						</div>
        			</div>
        			<div class="row h_blog_item">
        				<div class="col-lg-6">
							<div class="h_blog_img">
								<img class="img-fluid" src="img/sofa/sofa3.png" alt="">
							</div>
						</div>
						<div class="col-lg-6">
							<div class="h_blog_text">
								<div class="h_blog_text_inner left">
									<h4>Is a piece of furniture <br /></h4>
        			...
        			<div class="row h_blog_item">
						<div class="col-lg-6">
							<div class="h_blog_text">
								<div class="h_blog_text_inner right">
									<h4>Structure <br /></h4>
									<p>Even though you don't see the sofa's structure, it forms the basis of how comfortable the sofa is for the user. </p>
									<a class="main_btn2" href="#">Explore Gallery</a>
								</div>
							</div>
						</div>
						<div class="col-lg-6">
							<div class="h_blog_img">
								<img class="img-fluid" src="img/sofa/sofa4.png" alt="">
							</div>
						</div>
        			</div>
        		</div>
