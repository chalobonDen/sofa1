...
<?php
include "connect.php";
$result1 = mysqli_query($connect, "SELECT DISTINCT Types FROM sofa_finished");
$result2 = mysqli_query($connect, "SELECT * FROM materials WHERE Type_Mat = 'External' ");
?>
<center>
<br><br>
...
<br>
    <table>
        <form method="POST" action="save_product.php">
            <tr>
                <td><label>Sofa Name :</label></td>
                <td><input type="text" name="Sofa_name" style="width:270px;"></td>
			</tr>
            <tr>
                <td><label>Color :</label></td>
                <td><input type="text" name="Sofa_color" style="width:270px;"></td>
			</tr>
            <tr>
                <td><label>Size :</label></td>
                <td>
                    <select name="Types">
                        <option value=""><-- Please Select Types --></option>
                        <?php
            ...
            <tr>
                ...
                <td><input type="number" name="Price" style="width:270px;"></td>
			</tr>
            <tr>
                <td><label>Description :</label></td>
                <td><input type="text" name="Sofa_Des" style="width:270px;"></td>
			</tr>
