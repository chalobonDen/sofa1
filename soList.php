...
$userQuery = "SELECT * FROM `document_header_sale` JOIN `customers` using(Customer_ID)
                where `Doc_type_ID` = 6 and status_c=0
...
<center>
	<div><br><br><br><br>
    <h1><b>Sale Order List</b></h1><br><br>
    <a href="soListHis.php" ><h3>Sale Order History <i class="fa fa-history fa-lg" aria-hidden="true"></i></h3></a><br><br><br><br>
</div> 
	<table border="0" cellpadding="20" bgcolor="#fff" class="PrPoList">
<thead>	
	<tr class="w3-blue">
		<th><center>QA ID</center></th>
		<th><center>SO ID</center></th>
		<th><center>Customer Name</center></th>
		<th><center>Document Date</center></th>
		<th><center>Good Issue</center></th>
...
<tbody>
		<?php while ($row = mysqli_fetch_assoc($result)) { ?>
            <tr >
                <td><center>QA#00<?=$row["Ref_ID"]?></center></td>
                <td><center>SO#00<?=$row["Doc_sale_ID"]?></center></td>
                <td><center><?=$row["Customer_name"]?></center></td>
                <td><center><?=$row["Doc_date"]?></center></td>

                <td><center><a href="show_so1.php?id=<?=$row["Doc_sale_ID"]?>">
                  <i class="genric-btn danger radius">Good Issue</i>
                  </a></center>
                </td>
                <td><center><a href="show_so.php?id=<?=$row["Doc_sale_ID"]?>">
                  <i class="genric-btn danger radius">View</i>
                  </a></center>
				</td>

				<td><center><a href="stock_sofa_list.php">
                  <i class="genric-btn danger radius">Check Availability</i>
                  </a></center>
                </td>
		<?php } ?>				
			</tr>
...
?>
        ...
        <!--================Instagram Area =================-->
		<br><br><br><br> <section class="instagram_area">
