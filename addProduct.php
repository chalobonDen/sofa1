...
<?php
include "connect.php";
$result1 = mysqli_query($connect, "SELECT * FROM inventory_sofa JOIN sofa_finished USING(Sofa_ID)");
$result2 = mysqli_query($connect, "SELECT * FROM sofa_finished JOIN material_good USING(Sofa_ID) GROUP BY Sofa_ID");
$result3 = mysqli_query($connect, "SELECT * FROM stock_material");
$result4 = mysqli_query($connect, "SELECT * FROM materials");
?>
<center>
<br><br>
<div class="create PR">
...
<br>
      <table>
          <form method="POST" action="save_create_sofa.php">
                <tr>
                    <td><label>Product:</label></td>
                    <td>
                        <select name="Sofa_ID">
                            <option value=""><-- Please Select Sofa --></option>
                            <?php
                            while($row2 = $result2->fetch_assoc())
                            {
                                $Sofa_ID = $row2['Sofa_ID'];
                                $Sofa_name = $row2['Sofa_name']; 
              ...
              <tr>
                  ...
                  <td><input type="number" name="Qty" style="width:270px;"></td>
              </tr>
              <tr>
                  <td>
                      <button class="genric-btn danger circle arrow">Create Sofa<span class="lnr lnr-arrow-right"></span></button>
                  </td>
              </tr>
          </form>
      </table>
