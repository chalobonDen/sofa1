...
<?php
include "connect.php";
$resultdocument = mysqli_query($connect, "SELECT * FROM document_header_purchase where `Doc_type_ID` = 2 and status=1 and mod(`Ref_ID`,2)=1");
...
<body>
    <section>
        <center>
            ...
            <br>  
        <form method="POST" action="show_po_his.php">
        <table>
			<tr>
