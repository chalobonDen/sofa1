...
<html lang="en">
    ...
    <body>
        ...
        <?php
include "connect.php";
$userQuery = "SELECT * FROM invoice_to_customers";
$result = mysqli_query($connect, $userQuery);

$userQuery1 = "SELECT * FROM invoice_from_vendors";
...
<div class="content"><br><br>
	...
	<thead>	
		...
		<?php while ($row = mysqli_fetch_assoc($result)) { 
                      $have=$row["Payment_total_c"]; 
                      $sum+=$have;
        }
        ?>
		<?php while ($row1 = mysqli_fetch_assoc($result1)) { 
                      $have1=$row1["Payment_total"]; 
                      $minus+=$have1;
        }
        ?>
...
<br><br>
        ...
        <!--================Instagram Area =================-->
		<br> <section class="instagram_area">
