...
<?php
include "connect.php";
$resultCus = mysqli_query($connect, "SELECT * FROM customers");
...
$resultSofa = mysqli_query($connect, "SELECT * FROM sofa_finished");
?>
<center>
<br><br>
<div class="create PR">
...
<br>
      <table>
          <form method="POST" action="save_inq.php">
                  ...
                  <td>
                      <select name="Customer_ID">
                          ...
                          <?php
                          while($rows = $resultCus->fetch_assoc())
                          {
              ...
              <tr>
                  ...
                  <td><input type="date" name="Delivery_date" style="width:270px;"></td>
              </tr>
              <tr>
                  <td><label>Payment term :</label></td>
                  <td><input type="text" name="Payment_terms" style="width:270px;"></td>
              </tr>
              <tr>
