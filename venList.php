							...
							<ul class="nav navbar-nav menu_nav ml-auto">
								...
								<li class="nav-item submenu dropdown">
									...
									<ul class="dropdown-menu">
										...
										<li class="nav-item"><a class="nav-link" href="change_mat.php">change material</a></li>
										<li class="nav-item"><a class="nav-link" href="venList.php">Add product</a></li>
										<li class="nav-item"><a class="nav-link" href="cusList.php">create product</a></li>
									</ul>
								</li> 
    ...
    <tbody>
		<?php while ($row = mysqli_fetch_assoc($result)) { ?>
			<tr>
                ...
                <td><center><a href="info_ven.php?id=<?=$row["Vendor_ID"]?>">
                  <i class="genric-btn danger circle">Infomation</i>
                  </a></center>
                </td>
