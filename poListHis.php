...
$userQuery = "SELECT * FROM `document_header_purchase` JOIN `vendors` using(Vendor_ID)
                where `Doc_type_ID` = 2 and status=1 and mod(`Doc_purchase_ID`,2)=1 
						...
						<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
							<ul class="nav navbar-nav menu_nav ml-auto">
								...
								<li class="nav-item submenu dropdown">
									...
									<ul class="dropdown-menu">
										<li class="nav-item"><a class="nav-link" href="matList.php">BOM</a></li>
										<li class="nav-item"><a class="nav-link" href="select_change_mat.php">change material</a></li>
										<li class="nav-item"><a class="nav-link" href="venList.php">Add product</a></li>
...
<center>
	<div><br><br><br><br>
    <h1><b>Purchase Order History List</b></h1><br><br>
	<a href="poList.php" ><h3>Purchase Order <i class="fa fa-history fa-lg" aria-hidden="true"></i></h3></a><br><br><br><br>
</div> 
...
<thead>	
		...
		<?php } ?>
					...
					<form method="post" action="select_po_his.php">
                    	...
                    	<input type="submit" name="goodreceive" value="View PO" class="genric-btn danger circle">
					</form>
