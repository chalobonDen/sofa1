...
<html lang="en">
    ...
    <body>
        ...
        <?php
include "connect.php";
$userQuery = "SELECT * FROM `stock_sofa` JOIN sofa_finished USING(Sofa_ID)";
...
<a href="inventory_sofa_list.php"><h3>Inventory of product</h3></a>
<?php
