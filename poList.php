...
$userQuery = "SELECT * FROM `document_header_purchase` JOIN `vendors` using(Vendor_ID)
                where `Doc_type_ID` = 2 and status=0 and mod(`Ref_ID`,2)=1
...
<center>
	<div><br><br><br><br>
    <h1><b>Purchase Order List</b></h1><br><br>
	<a href="poListHis.php" ><h3>Purchase Order History <i class="fa fa-history fa-lg" aria-hidden="true"></i></h3></a><br><br><br><br>
</div> 
...
<thead>	
		...
		<?php } ?>
					...
					<form method="post" action="select_po.php">
                    	...
                    	<input type="submit" name="goodreceive" value="Good Receive" class="genric-btn danger circle">
					</form>
