...
<?php
include "connect.php";
$sql1= "SELECT * FROM sofa_finished";

$sql2= "SELECT * FROM document_header_sale
        WHERE Doc_sale_ID = '{$_GET["id"]}' ";
$sql3= "SELECT * FROM conditions WHERE Condition_ID = 2";
$resultSofa = mysqli_query($connect, $sql1) or die(mysqli_error($connect));
...
$dc = mysqli_fetch_assoc($rs3);
$Condition_ID = $dc['Condition_ID']; 
$Condition_name = $dc['Condition_name']; 
// --------------------------------


//$material = mysqli_fetch_all($row1, MYSQLI_ASSOC);
?>
...
<br>
    <table>
        <form method="POST" action="save_inq_mat.php">
			<tr>
                <td><label>INQ ID :</label></td>
                <td>
                    <input class="w3-input w3-border" name="Doc_sale_ID" type="text" value="<?=$ds2["Doc_sale_ID"]?>"  readonly>
                </td>
            </tr>
		  	...
		  	<tr>
                ...
                <td>
                    <select name="Sofa_ID">
                        ...
                        <?php
                        while($rows = $resultSofa->fetch_assoc())
                        {
            ...
            <tr type="hidden">
                <td><label> </label></td>
                <td> 
                    <input class="w3-input w3-border" name="Condition_ID" type="hidden" value="<?=$Condition_ID?>"  readonly>
                    <input class="w3-input w3-border" name="Condition_name" type="hidden" value="<?=$Condition_name?>"  readonly>
                </td>
            </tr>
			<tr>
                <td>
