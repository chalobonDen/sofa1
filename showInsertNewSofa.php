...
$userQuery = "SELECT * FROM `history_sofa` 
...
<center>
	<div><br><br><br><br>
    <h1><b>History of create new sofa</b></h1><br><br>
...
<thead>	
		...
		<?php while ($row = mysqli_fetch_assoc($result)) { ?>
			<tr>
                ...
                <td><center><a href="show_bom1.php?id=<?=$row["Sofa_ID"]?>">
                  <i class="genric-btn danger radius">View BOM</i>
                  </a></center>
                </td>
		<?php } ?>
