...
<html lang="en">
    ...
    <body>
        ...
        <?php
include "connect.php";
// WHERE mod(`inventory_sofaID`,2)=1
$userQuery = "SELECT * FROM `inventory_sofa` JOIN sofa_finished USING(Sofa_ID) JOIN line_item_sales USING(Sofa_ID) JOIN document_header_sale USING(Doc_sale_ID) WHERE Doc_type_ID = 5 ORDER BY inventory_sofaID DESC";
$result = mysqli_query($connect, $userQuery);
// แก้ userQuery เพิ่ม join ตาราง line กับ doc -- ทำที่ mat ด้วย
if (!$result)
{
...
<center>
<br><br><br><br>
<div class="change mat">
<h1>INVENTORY OF PRODUCT</h1><br><br>
<a href="stock_sofa_list.php"><h3>Check Availability <i class="fa fa-check-circle-o fa-lg" aria-hidden="true"></i></h3></a>
<?php


?>
<div class="content" ><br><br>
	<table border="0" bgcolor="#fff" class="PrPoList">
	<thead>
    	<tr>
			<th>INQ ID</th>
			<th>Sofa ID</th>
