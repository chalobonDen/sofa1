...
<html lang="en">
    ...
    <body>
        ...
        <?php
include "connect.php";
$userQuery = "SELECT * FROM `inventory_mat` JOIN materials USING(Material_ID) WHERE mod(`inventoryID`,2)=1 ORDER BY InventoryID DESC";
...
<h1>INVENTORY OF MATERIALS</h1><br><br>
<a href="stock_mat_list.php"><h3>Check Availability <i class="fa fa-check-circle-o fa-lg" aria-hidden="true"></i> </h3></a>
<?php
