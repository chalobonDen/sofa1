...
<center>
	<div><br><br><br><br>
    <h1><b>Purchase Requisition List</b></h1><br><br>
        <a href="prListHis.php" class="a1"><h3>Purchase Requisition History <i class="fa fa-history fa-lg" aria-hidden="true"></i></h3></a>
        <a href="create_pr.php"><h3>Create Purchase Requisition <i class="fa fa-file-text-o fa-lg" aria-hidden="true"></i></h3></a><br><br><br><br>
    </div> 
    ...
    <tbody>
		...
		<?php } ?>
					...
					<form method="post" action="addMat.php">
                        ...
                        <input type="submit" name="addMat" value="Add Material" class="genric-btn danger radius">
					</form>
				
				
					<form action="select_pr.php" method="post">	
						<input type="submit" name="po" value="Create PO" class="genric-btn danger radius">
					</form><br>
					<br>				
			</tr>
			<br>
